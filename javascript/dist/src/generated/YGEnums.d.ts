...
export declare enum GridTrackType {
    Auto = 0,
    Points = 1,
    Percent = 2,
    Fr = 3,
...
declare const constants: {
    ...
    ERRATA_MIN_SIZE_UNDEFINED_INSTEAD_OF_AUTO: Errata;
    ERRATA_ALL: Errata;
    ERRATA_CLASSIC: Errata;
    EXPERIMENTAL_FEATURE_WEB_FLEX_BASIS: ExperimentalFeature;
    EXPERIMENTAL_FEATURE_FIX_FLEX_BASIS_FIT_CONTENT: ExperimentalFeature;
    ...
    GRID_TRACK_TYPE_AUTO: GridTrackType;
    GRID_TRACK_TYPE_POINTS: GridTrackType;
    GRID_TRACK_TYPE_PERCENT: GridTrackType;
    GRID_TRACK_TYPE_FR: GridTrackType;
    GRID_TRACK_TYPE_MINMAX: GridTrackType;
    GUTTER_COLUMN: Gutter;
    GUTTER_ROW: Gutter;
    GUTTER_ALL: Gutter;
    JUSTIFY_AUTO: Justify;
    ...
    UNIT_PERCENT: Unit;
    UNIT_AUTO: Unit;
    UNIT_MAX_CONTENT: Unit;
    UNIT_FIT_CONTENT: Unit;
    UNIT_STRETCH: Unit;
    WRAP_NO_WRAP: Wrap;
    WRAP_WRAP: Wrap;
